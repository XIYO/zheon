...
const SUPABASE_URL = Deno.env.get("SUPABASE_URL") || Deno.env.get("PUBLIC_SUPABASE_URL") || "http://127.0.0.1:54321"
const SUPABASE_ANON_KEY = Deno.env.get("SUPABASE_ANON_KEY") || Deno.env.get("PUBLIC_SUPABASE_ANON_KEY")
