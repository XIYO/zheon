...
const supabaseAnonKey = Deno.env.get("SUPABASE_ANON_KEY") || Deno.env.get("PUBLIC_SUPABASE_ANON_KEY")
...
Deno.test({
  ...
  async fn() {
    ...
    assertEquals(corsHeaders.get("Access-Control-Allow-Methods"), "POST, OPTIONS", "Should allow POST and OPTIONS")
