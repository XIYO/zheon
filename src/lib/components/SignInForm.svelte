...
<form
	...
	<div class="text-center space-y-2">
		<p class="text-surface-600">Google 계정으로 안전하게 로그인하세요</p>
	...
	<div class="text-center">
		<p class="text-sm text-surface-500">
			로그인 시 <a href="/terms" class="text-primary-600 hover:text-primary-700 underline">이용약관</a> 및 
			<a href="/privacy" class="text-primary-600 hover:text-primary-700 underline">개인정보처리방침</a>에 동의합니다
		</p>
	</div>
</form>
