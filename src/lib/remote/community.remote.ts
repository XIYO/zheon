...
export const analyzeCommunityMetrics = query(AnalyzeCommunitySchema, async ({ videoId, maxBatches = 5 }) => {
  ...
  const service = new CommunityMetricsService(adminSupabase as any);
