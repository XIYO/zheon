<script>
  import { collectComments, getCommentsFromDB } from '$lib/remote/youtube/comments.remote.js';
...
<main class="container mx-auto px-4 py-8 space-y-6">
  ...
  <section class="space-y-4">
    ...
    {:else}
      <ul class="space-y-3">
        {#each commentList as comment, idx}
          {@const data = comment.data}
          <li class="rounded-xl border border-surface-200 bg-white p-4 shadow-sm dark:border-surface-800 dark:bg-surface-900">
