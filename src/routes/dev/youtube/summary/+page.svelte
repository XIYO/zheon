<script>
	import { analyzeVideo } from '$lib/remote/summary.remote.ts';
	...
	async function handleAnalyze() {
		...
		try {
			...
			await analyzeVideo({ videoId: vid });
...
<main class="container mx-auto px-4 py-8 space-y-6">
	...
	{#if summary}
		<section class="space-y-6">
			<div
				class="rounded-xl border border-surface-200 bg-white p-6 dark:border-surface-800 dark:bg-surface-900">
				...
				<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
					...
					<div>
						...
						<div class="space-y-2">
							<div>
								<div
									class="flex justify-between text-xs text-surface-600 dark:text-surface-400 mb-1">
									<span>긍정</span>
									<span>{summary.sentiment_positive_ratio}%</span>
								</div>
								<div
									class="w-full h-6 bg-surface-100 rounded-full overflow-hidden dark:bg-surface-800">
									<div
			...
			<div
				...
				<div class="grid grid-cols-2 md:grid-cols-4 gap-4">
					<div
						class="col-span-2 md:col-span-4 text-center p-4 rounded-lg bg-surface-50 dark:bg-surface-800">
			...
			<div
				...
				<div class="space-y-4">
					<div class="p-4 rounded-lg bg-surface-50 dark:bg-surface-800">
						<h3 class="text-sm font-semibold mb-2 text-surface-700 dark:text-surface-300">
							콘텐츠 요약
						</h3>
					...
					<div class="p-4 rounded-lg bg-surface-50 dark:bg-surface-800">
						...
						{#if summary.ai_key_insights && summary.ai_key_insights.length > 0}
							<ul class="list-disc list-inside space-y-1">
								{#each summary.ai_key_insights as insight (insight)}
					...
					<div class="p-4 rounded-lg bg-surface-50 dark:bg-surface-800">
						...
						{#if summary.ai_recommendations && summary.ai_recommendations.length > 0}
							<ul class="list-disc list-inside space-y-1">
								{#each summary.ai_recommendations as recommendation (recommendation)}
