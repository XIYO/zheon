...
<div class="container mx-auto max-w-md p-6">
	<h1 class="text-xl font-bold mb-8">계정</h1>

	<div class="card preset-elevated p-6">
		<!-- 연결된 계정 -->
		<div class="mb-6">
			<h2 class="text-xl font-bold mb-2 text-surface-600 dark:text-surface-400">연결된 계정</h2>
		...
		<!-- YouTube 구독 관리 -->
		<div class="mb-6">
			<h2 class="text-xl font-bold mb-3 text-surface-600 dark:text-surface-400">연결된 서비스</h2>
