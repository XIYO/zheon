				...
				<div class="flex items-center justify-between">
					...
					<div class="flex items-center space-x-3">
						<div class="relative">
							...
							<div
                                class="absolute -inset-1 rounded-lg preset-tonal-primary opacity-15 blur-lg">
							</div>
						</div>
                                ...
                                <div class="p-6">
									...
									<div class="space-y-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-surface-500-500">{formatDate(summary.created_at)}</div>
                                        </div>
										</div>
				...
				<div class="lg:col-span-2">
					<div class="space-y-8">
                        ...
                        class="flex space-x-1 rounded-3xl border border-surface-200-800/40 preset-glass-surface p-2 backdrop-blur-xl">
                            <button
                                class="btn variant-filled-primary btn-base flex-1">
                                📝 AI 요약
                            </button>
                            <button
						...
						<!-- 읽기 진행률 -->
                        <div class="rounded-2xl border border-surface-200-800/40 preset-glass-surface p-4 backdrop-blur-xl">
                            ...
                            <div class="h-2 rounded-full bg-surface-200-800">
                                <div
                                    class="h-2 w-0 rounded-full bg-primary-600-400 transition-all duration-300">
                                </div>
                            </div>
                        </div>
                    ...
                    <article
                        ...
                        <div class="absolute inset-0 preset-tonal-primary opacity-5"></div>
							...
							<div class="relative">
								<!-- 헤더 -->
                            <div
                                class="border-b border-surface-200-800/50 preset-tonal-surface px-8 py-6">
                                ...
                                <div class="p-8">
                                    <div class="prose prose-lg max-w-none">
                                        <div
                                            class="rounded-2xl preset-tonal-surface p-8 shadow-inner">
                                ...
                                <div class="p-8">
                                    ...
                                    <div class="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
                                        <div
                                            ...
                                            <div class="text-2xl font-bold text-primary-600-400">{summary.summary.length}</div>
                                            <div class="text-xs text-surface-600-400">요약 글자 수</div>
                                        </div>
                                        <div
                                            class="rounded-2xl preset-glass-surface p-4 text-center backdrop-blur-sm border border-surface-200-800/40">
                                            <div class="text-2xl font-bold text-secondary-600-400">{summary.content.length}</div>
