...
<div class="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-100">
	<!-- 배경 패턴 -->
	<div
		class="fixed inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(59,130,246,0.1),transparent_50%)]">
	</div>
	<div
		class="fixed inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(168,85,247,0.1),transparent_50%)]">
	</div>
				...
				<div class="flex items-center justify-between">
					...
					<div class="flex items-center space-x-3">
						<div class="relative">
							...
							<div
								class="absolute -inset-1 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 opacity-20 blur-lg">
							</div>
						</div>
			...
			<div class="grid gap-8 lg:grid-cols-3">
				...
				<div class="lg:col-span-1">
					<div class="sticky top-8 space-y-6">
						<!-- 영상 카드 -->
						<div
							class="relative overflow-hidden rounded-3xl border border-white/20 bg-white/60 shadow-2xl backdrop-blur-xl">
							<!-- 글로우 효과 -->
							...
							<div class="relative">
								...
								<div class="relative overflow-hidden">
									...
									<a
										...
										<div
											class="rounded-full bg-white/90 p-6 shadow-2xl backdrop-blur-sm transition-all group-hover:bg-red-600 group-hover:text-white group-hover:scale-110">
								...
								<!-- 영상 정보 -->
								<div class="p-6">
									<h1 class="mb-4 text-xl font-bold text-neutral-900 leading-tight">
										{summary.title}
									</h1>
				...
				<div class="lg:col-span-2">
					<div class="space-y-8">
						<!-- 탭 네비게이션 -->
						<div
							class="flex space-x-1 rounded-3xl border border-white/20 bg-white/60 p-2 backdrop-blur-xl">
							<button
								class="flex-1 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-3 text-sm font-semibold text-white shadow-lg transition-all">
								📝 AI 요약
							</button>
							<button
								class="flex-1 rounded-2xl px-6 py-3 text-sm font-medium text-neutral-600 transition-all hover:bg-white/50">
								📄 전체 내용
							</button>
						</div>
						...
						<div class="rounded-2xl border border-white/20 bg-white/60 p-4 backdrop-blur-xl">
							...
							<div class="h-2 rounded-full bg-neutral-200">
								<div
									class="h-2 w-0 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 transition-all duration-300">
								</div>
							</div>
						</div>
						...
						<!-- AI 요약 섹션 -->
						<article
							class="group relative overflow-hidden rounded-3xl border border-white/20 bg-white/80 shadow-2xl backdrop-blur-xl">
							<!-- 글로우 효과 -->
							<div class="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-purple-500/5"></div>
							...
							<div class="relative">
								<!-- 헤더 -->
								<div
									class="border-b border-neutral-200/50 bg-gradient-to-r from-blue-50 to-purple-50 px-8 py-6">
								...
								<div class="p-8">
									<div class="prose prose-lg max-w-none">
										<div
											class="rounded-2xl bg-gradient-to-br from-neutral-50 to-white p-8 shadow-inner">
									...
									<div class="mt-8 flex flex-wrap gap-4">
										<button
											class="group inline-flex items-center gap-2 rounded-2xl border border-neutral-200 bg-white px-6 py-3 font-medium text-neutral-700 shadow-sm transition-all hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700">
										...
										<button
											class="group inline-flex items-center gap-2 rounded-2xl border border-neutral-200 bg-white px-6 py-3 font-medium text-neutral-700 shadow-sm transition-all hover:border-purple-300 hover:bg-purple-50 hover:text-purple-700">
											<svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
												<path
													stroke-linecap="round"
													stroke-linejoin="round"
						...
						<article
							...
							<div class="relative">
								<!-- 헤더 -->
								<div
									class="border-b border-neutral-200/50 bg-gradient-to-r from-green-50 to-blue-50 px-8 py-6">
									<div class="flex items-center gap-4">
								...
								<div class="p-8">
									<div class="prose prose-base max-w-none">
										...
										<div
											...
											<div class="columns-1 gap-8 md:columns-2 lg:columns-2">
												<p
													class="break-inside-avoid text-base leading-7 text-neutral-700 whitespace-pre-line">
													{summary.content}
												</p>
											</div>
										</div>
									...
									<div class="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
										<div
											class="rounded-2xl bg-white/60 p-4 text-center backdrop-blur-sm border border-white/20">
